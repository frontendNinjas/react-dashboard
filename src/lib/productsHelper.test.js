import {addProducts} from './productsHelper'

test('addProducts should add the passed products to the list', () => {
    const startProducts = [
        {
            productid: "1",
            productname: "Material-UI",
            bodyHtml: "Material-UI is a set of React components that implement Google's Material Design" +
                " specification.",
            price: "$9.99",
    ...
    const result = addProducts(startProducts, newProducts)
